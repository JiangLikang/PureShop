	...
	$(function() {
		if (location.search.indexOf('wid=') != -1) {
			...
			var pro = new Promise((open) => {
					$.ajax({
						url: 'http://www.pureshop.applinzi.com:5050/products_women/remai',
						type: 'get',
						dataType: 'json',
				...
				.then((open) => {
					$.ajax({
						url: 'http://www.pureshop.applinzi.com:5050/products_women/similar',
						type: 'get',
						dataType: 'json',
						success: function(res) {
							new Vue({
				...
				.then((open) => {
					$.ajax({
						url: 'http://www.pureshop.applinzi.com:5050/products_women/haixianggou',
						type: 'get',
						dataType: 'json',
						success: function(res) {
							// var haixianggou = res
				...
				.then((open) => {
					...
					$.ajax({
						url: 'http://www.pureshop.applinzi.com:5050/products_women/details',
						type: 'get',
						dataType: 'json',
						data: {
							wid
							...
							new Vue({
								...
								methods: {
									cmt_send: async function() {
										var res = await axios.post('http://www.pureshop.applinzi.com:5050/user/addComments', Qs.stringify({
											wid: this.wid,
									...
									get_comments_list: async function() {
										var res = await axios.get('http://www.pureshop.applinzi.com:5050/user/commentsList?wid=' + this.wid)
										this.list = res.data;
									},
									add_to_cart: async function() {
										var res = await axios.get('http://www.pureshop.applinzi.com:5050/user/addToCart', {
											params: {
												wid: this.wid,
